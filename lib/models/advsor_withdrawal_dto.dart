...
class AdvisorWithDrawlApiDto {
    AdvisorTransaction transaction;
    String tdocId;
    String userDocId;
    AdvisorUser user;

    AdvisorWithDrawlApiDto({
    ...
    factory AdvisorWithDrawlApiDto.fromJson(Map<String, dynamic> json) => AdvisorWithDrawlApiDto(
        transaction: AdvisorTransaction.fromJson(json["transaction"]),
        user: AdvisorUser.fromJson(json["user"]),
        tdocId:  json["tdocId"],
...
class AdvisorTransaction {
    String? transactionType;
   String? transactionHash;
    String? createdAt;
    String? chain;
    AdvisorTransactionDetails? transactionDetails;
    num? amount;
    ...
    factory AdvisorTransaction.fromJson(Map<String, dynamic> json) => AdvisorTransaction(
        transactionType: json["transactionType"]??'',
        transactionHash:json['transactionHash']??'',
        createdAt: json["createdAt"],
        chain: json["chain"],
        transactionDetails:json["transactionDetails"]==null?null: AdvisorTransactionDetails.fromJson(json["transactionDetails"]),
...
class AdvisorTransactionDetails {
    num? gasFee;
    num? onRampFee;
    num? gatewayFee;
    String? provider;
    ...
    factory AdvisorTransactionDetails.fromJson(Map<String, dynamic> json) => AdvisorTransactionDetails(
...
class AdvisorUser {
    ...
    factory AdvisorUser.fromJson(Map<String, dynamic> json) => AdvisorUser(
